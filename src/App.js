        ...
        <Row>
          ...
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            <div className="mt-4 mb-4">
              <Button variant="light" size="sl" style={{ marginRight: '200px'}}>
                New
              </Button>{' '}
            ...
            {/* Row Image  */}
            <Row>
            <Card.Img variant="top" src="https://proofmart.com/wp-content/uploads/2021/06/522-26.png" />
            </Row>
            {/* Row Title */}
            <Row>
            <Card.Body>
            ...
            {/* rattings*/}
              ...
              {/* Price and cart button */}
                ...
                <InputGroup  className="mb-2" style={{ width: '250px' , marginRight:'10px',}}>
                  ...
                  />
                <InputGroup.Text>
                <Button variant="light"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
         ...
         <Col>
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Row Image  */}
            <Row>
            <Card.Img variant="top" src="https://proofmart.com/wp-content/uploads/2021/06/522-25.png" />
            </Row>
            {/* Row Title */}
            <Row>
            <Card.Body>
...
<Col>
          <Card style={{ width: '400px' ,top:'20px'}}>
            ...
            {/* Row Image  */}
            <Row>
            <Card.Img variant="top" src="https://proofmart.com/wp-content/uploads/2021/06/522-30.png" />
            </Row>
            {/* Row Title */}
            <Row>
            <Card.Body>
